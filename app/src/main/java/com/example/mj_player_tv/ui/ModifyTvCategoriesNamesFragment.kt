...
import com.example.mj_player_tv.databinding.FragmentModifyTvcategoryPreSuffixesBinding
...
class ModifyTvCategoriesNamesFragment : Fragment(R.layout.fragment_modify_tvcategory_pre_suffixes) {

    private var _binding: FragmentModifyTvcategoryPreSuffixesBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentModifyTvcategoryPreSuffixesBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (settings != null) {
                ...
                binding.editTextPrefixes.setText(settings.tvcategoryPrefixes.joinToString(","))
                binding.editTextSuffixes.setText(settings.tvcategorySuffixes.joinToString(","))
    ...
    private fun saveNewPreAndSuffixes() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            if (settings != null) {
                ...
                settings.tvcategoryPrefixes.clear()
                settings.tvcategoryPrefixes = newPrefixes.toMutableList()
                settings.tvcategorySuffixes.clear()
