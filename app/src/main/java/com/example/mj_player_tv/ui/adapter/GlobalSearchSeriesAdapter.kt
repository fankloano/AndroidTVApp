...
@UnstableApi
class GlobalSearchSeriesAdapter(private val onClickListener: GlobalSearchSeriesAdapter.OnClickListener, private val fragment: GlobalSearchFragment, private val helpViewModel: HelpViewModel) : ListAdapter<SeriesOB, GlobalSearchSeriesAdapter.ViewHolder>(
