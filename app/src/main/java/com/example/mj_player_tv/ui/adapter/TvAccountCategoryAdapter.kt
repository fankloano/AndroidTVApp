...
@UnstableApi
class TvAccountCategoryAdapter(
    ...
    private val oncategorylongClickListener: TvAccountCategoryAdapter.OnLongClickListener
    ...
    inner class AccountViewHolder(
        ...
        private fun handleRightShortPress() {
            fragment.setFocusToTvChannelsFromAccount()
        }
            ...
            binding.rvLinearTvCategory.setOnFocusChangeListener { _, hasFocus ->
                ...
                if (hasFocus) {
                    focusRunnable = Runnable {
                        fragment.showChannelList(tvCategory.id)
                    }
