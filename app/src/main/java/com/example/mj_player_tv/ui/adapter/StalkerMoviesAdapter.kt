...
@UnstableApi
class StalkerMoviesAdapter(
    private val onClickListener: OnClickListener,
    private val onLongClickListener: OnLongClickListener,
    private val fragment: MoviesFragment,
    private val helpViewModel: HelpViewModel
) : PagingDataAdapter<MovieOB, StalkerMoviesAdapter.ViewHolder>(MOVIE_COMPARATOR) {
    ...
    companion object {
        private val MOVIE_COMPARATOR = object : DiffUtil.ItemCallback<MovieOB>() {
