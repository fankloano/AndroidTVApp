...
class AccountTvCategoriesAdapter(
    ...
    private val fragment: AccountTvCategoriesFragment,
    private val expandCollapseListener: (AccountTvCategory.Account, accountPosition: Int) -> Unit,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            VIEW_TYPE_CATEGORY -> {
                ...
                TvCategoryViewHolder(binding, fragment, helpViewModel, { selectedTvCategoryId })
            }
    ...
    inner class AccountViewHolder(
        ...
        private val expandCollapseListener: (AccountTvCategory.Account, Int) -> Unit,
        private val helpViewModel: HelpViewModel,
        private val fragment: AccountTvCategoriesFragment
                    ...
                    KeyEvent.ACTION_UP -> {
                        ...
                        if (pressDuration < longPressDuration && !isLongPress) {
                            when (keyCode) {
                                ...
                                KeyEvent.KEYCODE_DPAD_CENTER -> handleCenterShortPress(account)
                            }
                        }
        ...
        private fun handleCenterShortPress(account: AccountTvCategory.Account) {
            val adapterPosition = bindingAdapterPosition
            if (adapterPosition != RecyclerView.NO_POSITION) {
                expandCollapseListener(account, adapterPosition)
            }
        }
    ...
    inner class TvCategoryViewHolder(
        ...
        fun bind(tvCategory: AccountTvCategory.TvCategory) {
            ...
            binding.rvLinearTvCategory.setOnFocusChangeListener { _, hasFocus ->
                ...
                if (hasFocus) {
                    fragment.loadChannelsForCategory(tvCategory.id)
                }
            }
        }
