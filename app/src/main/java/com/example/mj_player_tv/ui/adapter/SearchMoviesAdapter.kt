...
@UnstableApi
class SearchMoviesAdapter(private val onClickListener: SearchMoviesAdapter.OnClickListener, private val fragment: SearchMovieByCategoryFragment, private val helpViewModel: HelpViewModel) : ListAdapter<MovieOB, SearchMoviesAdapter.ViewHolder>(
